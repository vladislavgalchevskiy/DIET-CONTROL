...
public final class ProductListBinding implements ViewBinding {
  ...
  private ProductListBinding(@NonNull CardView rootView, @NonNull CardView productCard,
  ...
  public static ProductListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProductListBinding((CardView) rootView, productCard, productList);
    }
